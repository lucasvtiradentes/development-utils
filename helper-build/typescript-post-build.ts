...
copyTypescriptIgnoredFilesToDist("./assets", DIST_FOLDER, ALREADY_COPIED_TS_EXTENSIONS)
copyTypescriptIgnoredFilesToDist("./configs", DIST_FOLDER, ALREADY_COPIED_TS_EXTENSIONS)
