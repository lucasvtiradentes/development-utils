...
This is whatsapp chatbot boilerplate I use whenever I need to create whatsapp automations.

## :information_source: Features

- [x] Uses the most complete whatsapp automation api, the <a href="https://github.com/orkestral/venom" target="_blank">Venom bot</a> api;
- [x] Fast whatsapp automation coding.
