...
$ git clone https://github.com/lucasvtiradentes/express-server-typescript-boilerplate

# Go into the repository
$ cd lucasvtiradentes/express-server-typescript-boilerplate
